...
namespace Desktop.DAO
{
    public class TheDocGiaDAO
    {
        ...
        {
            string Query = "select TheDocGia.*,Users.UserName,Pwd,LoaiDocGia.TenLoaiDG From TheDocGia,Users,LoaiDocGia where TheDocGia.IDDocGia = Users.IDDocGia and LoaiDocGia.IDLoaiDG = TheDocGia.IDLoaiDG order by IDDocGia asc";
            return Query;
        }
        #endregion
        #region Search
        ...
        {
            string Query = "UPDATE USERS SET UserName = '" + user.UserName + "',Pwd = '" + user.Password + "' WHERE IDDocGia = '" + user.IDDocGia + "'";
            return Query;
        }
        #endregion
